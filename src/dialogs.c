...
struct UIItem diaPadEmuConfig[] = {
    ...
    {UI_LABEL, 0, 1, 1, -1, -50, 0, {.label = {NULL, _STR_PADEMU_MODULES_SET}}},
    {UI_SPACER},
    {UI_BUTTON, PADCFG_PADEMU_MODULES_SET, 1, 1, _STR_HINT_PADEMU_MODULES_SET, 0, 0, {.label = {NULL, _STR_CONFIGURE}}},
    {UI_BREAK},
    {UI_BREAK},
